...
class FeishuBitableClient:
    ...
    def _validate_required_cyb_fields(self) -> None:
        """严格校验创业板/上证50字段存在；缺失时直接报错，避免写入残缺字段。"""
    ...
    def _build_csi_fields(self, record: Dict[str, float | str]) -> Dict[str, object]:
        ...
        fields = {
            ...
            "上证50指数": FeishuBitableClient._safe_float(record.get("上证50指数"), 0.0),
            ...
            "50分位": FeishuBitableClient._safe_float(record.get("50分位"), 0.0),
            ...
            "50偏离(%)": FeishuBitableClient._safe_float(record.get("50偏离(%)"), 0.0),
        ...
        optional_fields = {
            ...
            "上证50/300比价": FeishuBitableClient._safe_float(record.get("上证50/300比价"), 0.0),
            "科创50/300比价": FeishuBitableClient._safe_float(record.get("科创50/300比价"), 0.0),
            "1000/500比价": FeishuBitableClient._safe_float(record.get("1000/500比价"), 0.0),
            "创业板/上证50比价": FeishuBitableClient._safe_float(record.get("创业板/上证50比价"), 0.0),
            ...
            "上证50/300分位": FeishuBitableClient._safe_float(record.get("上证50/300分位"), 0.0),
            "科创50/300分位": FeishuBitableClient._safe_float(record.get("科创50/300分位"), 0.0),
            "1000/500分位": FeishuBitableClient._safe_float(record.get("1000/500分位"), 0.0),
            ...
            "上证50/300偏离(%)": FeishuBitableClient._safe_float(record.get("上证50/300偏离(%)"), 0.0),
            "科创50/300偏离(%)": FeishuBitableClient._safe_float(record.get("科创50/300偏离(%)"), 0.0),
            "1000/500偏离(%)": FeishuBitableClient._safe_float(record.get("1000/500偏离(%)"), 0.0),
            "创业板/上证50偏离(%)": FeishuBitableClient._safe_float(record.get("创业板/上证50偏离(%)"), 0.0),
            ...
            "上证50/300建议": FeishuBitableClient._safe_text(record.get("上证50/300建议")),
            "科创50/300建议": FeishuBitableClient._safe_text(record.get("科创50/300建议")),
            "1000/500建议": FeishuBitableClient._safe_text(record.get("1000/500建议")),
            "创业板/上证50建议": FeishuBitableClient._safe_text(record.get("创业板/上证50建议")),
