...
class FeishuWorkflowWebhookTest(unittest.TestCase):
    ...
    def test_relative_workflow_archives_legacy_erp_table_without_blocking(self):
        ...
        self.assertIn("ERP_ARCHIVE_FEISHU_APP_TOKEN: ${{ secrets.ERP_ARCHIVE_FEISHU_APP_TOKEN }}", relative_text)
        self.assertIn("ERP_ARCHIVE_FEISHU_TABLE_ID: ${{ secrets.ERP_ARCHIVE_FEISHU_TABLE_ID }}", relative_text)
        self.assertIn("ERP_LEGACY_FEISHU_APP_TOKEN: ${{ secrets.ERP_LEGACY_FEISHU_APP_TOKEN }}", relative_text)
        self.assertIn("ERP_LEGACY_FEISHU_TABLE_ID: ${{ secrets.ERP_LEGACY_FEISHU_TABLE_ID }}", relative_text)
        self.assertIn("ERP_FEISHU_APP_TOKEN: ${{ secrets.ERP_FEISHU_APP_TOKEN }}", relative_text)
        self.assertIn("ERP_FEISHU_TABLE_ID: ${{ secrets.ERP_FEISHU_TABLE_ID }}", relative_text)
        self.assertIn("FEISHU_BASE_ID: ${{ secrets.FEISHU_BASE_ID }}", relative_text)
